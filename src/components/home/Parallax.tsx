...
<motion.div 
      ...
      >
        <p className={`${spaceGrotesk.className} text-[10px] xs:text-xs sm:text-sm md:text-lg text-white/80 mb-2 mx-auto tracking-wide font-light`}>
          Transforming ideas into intelligent systems through code and innovation.
        </p>
        ...
        <div className="flex justify-center gap-6">
          ...
          <motion.a
            href="https://www.linkedin.com/in/aanjaneya-pandey-9715b2335/"
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            href="https://leetcode.com/u/Aanjaneya24/"
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
