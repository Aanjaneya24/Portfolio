...
import { FaEarthAmericas, FaPenFancy, FaReact, FaGithub } from "react-icons/fa6";
                  ...
                  <CardHoverEffect>
                    <div className="p-4 sm:p-6">
                      ...
                      {experience.department && (
                        <p className="text-xs sm:text-sm text-neutral-500 dark:text-neutral-400 mb-3 italic">
                          {experience.department}
                        </p>
                      )}

                      {experience.points && (
                        <ul className="text-xs sm:text-sm text-neutral-700 dark:text-neutral-300 mb-3 sm:mb-4 space-y-2 list-disc list-inside">
                      ...
                      {experience.link && (
                        <a
                          ...
                          className="inline-flex items-center gap-2 mb-3 sm:mb-4 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium
